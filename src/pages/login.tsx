...
export const Login = ({ touched, errors, values, setFieldTouched, setFieldValue, onNext }: Props) => {
  ...
  return <div className='widget-container flex flex-col'>
    ...
    <div className="flex-1 flex flex-col items-center justify-center">
      {isRequiredLogin && <div className="text-center text-purple-600 mb-5">Required an account for purchasing over $500</div>}
      ...
      <div className="text-white mt-5">
        Don't have an account? <span className="cursor-pointer text-purple-600" onClick={() => setFieldValue('auth', 'signup')}>Sign up</span>
      </div>
    </div>
    {!isRequiredLogin && (
      <button
