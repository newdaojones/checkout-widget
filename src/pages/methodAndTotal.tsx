...
export const MethodAndTotal = ({ cost, tipPercent, paymentMethod, onChangePaymentMethod, onNext }: {
  cost?: number,
  tipPercent?: number,
    ...
    <div className="flex-1 flex flex-col justify-center">
      ...
      <div className="flex items-center justify-around">
        <button
          ...
          className={`h-11 bg-white/50 text-white flex items-center justify-center w-20 rounded-md cursor-pointer shadow-md shadow-white ${paymentMethod === 'card' ? 'bg-gradient-to-b from-purple-400 to-purple-600' : ''}`}
        >
        ...
        <button
          disabled
          className={`h-11 bg-white/50 text-white flex items-center justify-center w-20 rounded-md cursor-pointer shadow-md shadow-white ${paymentMethod === 'usdc' ? 'bg-gradient-to-b from-purple-400 to-purple-600' : ''}`}
          onClick={() => onChangePaymentMethod('usdc')}
        >
