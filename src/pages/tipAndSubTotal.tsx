    ...
    <div>
      ...
      <div className='mt-3 flex w-full justify-end items-center'>
        ...
        <div
          ...
          onClick={() => setFieldValue('tipPercent', '10')}
        >
          10%
        </div>
      </div>
      <div className='mt-3 flex w-full justify-end items-center'>
        ...
        <div
          ...
          onClick={() => setFieldValue('tipPercent', '15')}
        >
          15%
        </div>
      </div>
      <div className='mt-3 flex w-full justify-end items-center'>
        ...
        <div
          ...
          onClick={() => setFieldValue('tipPercent', '20')}
        >
          20%
        </div>
      </div>
      <div className='mt-3 flex w-full justify-end items-center'>
        ...
        {focusedCustomTip ?
          <input
            ...
            onChange={(e) => setFieldValue('tipPercent', e.target.value)}
